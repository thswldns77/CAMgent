 ...
 * @author Samchon
 */
export type AgenticaOperation<Model extends ILlmSchema.Model> = AgenticaOperation.Class<Model> | AgenticaOperation.Http<Model> | AgenticaOperation.Mcp<Model>;
export declare namespace AgenticaOperation {
    ...
    export type Mcp<Model extends ILlmSchema.Model> = Base<"mcp", IAgenticaController.IMcp<Model>, IMcpLlmFunction<Model>>;
