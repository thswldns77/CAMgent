 ...
 * @author Samchon
 */
export type AgenticaEvent<Model extends ILlmSchema.Model> = AgenticaUserMessageEvent | AgenticaAssistantMessageEvent | AgenticaInitializeEvent | AgenticaSelectEvent<Model> | AgenticaCallEvent<Model> | AgenticaCancelEvent<Model> | AgenticaExecuteEvent<Model> | AgenticaDescribeEvent<Model> | AgenticaValidateEvent<Model> | AgenticaRequestEvent | AgenticaResponseEvent;
