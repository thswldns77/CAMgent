 ...
 * @author Samchon
 */
export type MicroAgenticaEvent<Model extends ILlmSchema.Model> = AgenticaUserMessageEvent | AgenticaAssistantMessageEvent | AgenticaCallEvent<Model> | AgenticaExecuteEvent<Model> | AgenticaDescribeEvent<Model> | AgenticaRequestEvent | AgenticaResponseEvent | AgenticaValidateEvent<Model>;
