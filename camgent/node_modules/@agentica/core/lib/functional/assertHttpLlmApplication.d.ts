import type { IHttpLlmApplication, ILlmSchema, OpenApiV3, OpenApiV3_1, SwaggerV2 } from "@samchon/openapi";
 ...
 */
export declare function assertHttpLlmApplication<Model extends ILlmSchema.Model>(props: {
    /**
     * Target LLM model.
     */
    model: Model;
     ...
     */
    document: SwaggerV2.IDocument | OpenApiV3.IDocument | OpenApiV3_1.IDocument | OpenApi.IDocument | unknown;
    /**
