...
(function (CreateIsTransformer) {
    CreateIsTransformer.transform = (config) => (props) => GenericTransformer_1.GenericTransformer.factory(Object.assign(Object.assign({}, props), { method: config.equals ? "equals" : "is", write: (x) => IsProgrammer_1.IsProgrammer.write(Object.assign(Object.assign({}, x), { config })) }));
