...
(function (MetadataTypeTagSchemaFactory) {
    MetadataTypeTagSchemaFactory.object = (props) => {
        ...
        for (const p of props.object.properties) {
            ...
            if (key === null) {
                props.report(`${props.object.name} has non-literal key type: ${p.key.getName()}`);
                continue;
            }
            output[key] = iterate({
                report: props.report,
    ...
    const iterate = (props) => {
        if (props.metadata.any ||
            ...
            return tuple.type.elements.map((elem) => iterate({
                report: props.report,
                object: props.object,
                key: props.key,
                metadata: elem,
...
export { MetadataTypeTagSchemaFactory };
//# sourceMappingURL=MetadataTypeTagSchemaFactory.mjs.map
