...
const iterate = (props) => {
    ...
    if (props.metadata.objects.length > 1) {
        props.metadata.objects.sort((x, y) => MetadataObjectType.covers(x.type, y.type)
            ? -1
    ...
    if (props.metadata.arrays.length > 1)
        props.metadata.arrays.sort((x, y) => Metadata.covers(x.type.value, y.type.value)
            ? -1
...
export { iterate_metadata_sort };
//# sourceMappingURL=iterate_metadata_sort.mjs.map
