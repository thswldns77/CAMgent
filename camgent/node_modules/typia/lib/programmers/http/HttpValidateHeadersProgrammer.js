...
const HttpHeadersProgrammer_1 = require("./HttpHeadersProgrammer");
...
(function (HttpValidateHeadersProgrammer) {
    HttpValidateHeadersProgrammer.decompose = (props) => {
        ...
        const decode = HttpHeadersProgrammer_1.HttpHeadersProgrammer.decompose(props);
        return {
    ...
    HttpValidateHeadersProgrammer.write = (props) => {
        ...
        const result = HttpValidateHeadersProgrammer.decompose(Object.assign(Object.assign({}, props), { functor }));
