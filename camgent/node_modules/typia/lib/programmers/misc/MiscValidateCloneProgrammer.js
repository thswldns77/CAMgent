...
(function (MiscValidateCloneProgrammer) {
    MiscValidateCloneProgrammer.decompose = (props) => {
        ...
        return {
            functions: Object.assign(Object.assign({}, validate.functions), clone.functions),
            statements: [
                ...validate.statements,
                ...clone.statements,
            ...
            arrow: typescript_1.default.factory.createArrowFunction(undefined, undefined, [IdentifierFactory_1.IdentifierFactory.parameter("input", TypeFactory_1.TypeFactory.keyword("any"))], props.context.importer.type({
                file: "typia",
                name: "IValidation",
                arguments: [(_a = clone.arrow.type) !== null && _a !== void 0 ? _a : TypeFactory_1.TypeFactory.keyword("any")],
    ...
    MiscValidateCloneProgrammer.write = (props) => {
        ...
        const result = MiscValidateCloneProgrammer.decompose(Object.assign(Object.assign({}, props), { functor }));
